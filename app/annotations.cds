...
annotate alansmith_34_a42Srv.CustomerMessage with @UI.DataPoint #productName: {
  Value: productName,
  Title: 'Product Name',
};
annotate alansmith_34_a42Srv.CustomerMessage with {
...
annotate alansmith_34_a42Srv.CustomerMessage with @UI.HeaderFacets: [
...
annotate alansmith_34_a42Srv.CustomerMessage with @UI.Facets: [
